...
"The __pycache__ folder is automatically generated by Python when you run Python files within your folder"
"""
    The __pycache__ folder stores compiled bytecode versions of your Python scripts. 
    When Python executes a .py file, it compiles the code into bytecode to speed up future executions. This bytecode is saved as .pyc files inside the __pycache__ folder
"""
...
"""
    ...
    If there was a script in my_ml_project/ and you executed it, Python would create a __pycache__ folder at the root level. Running main.py from src/ will not create a __pycache__ folder in the root.
    
    This design allows Python to manage compiled code in a way that’s scalable and efficient, especially for projects that span multiple directories like your ML project.
